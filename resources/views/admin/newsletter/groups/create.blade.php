...
@section('page-description', 'Create a new list segment or subscriber group.')
    ...
    <div class="col-md-8 offset-md-2">
        <div class="card shadow-sm">
            <div class="card-header bg-white py-3">
                <h5 class="card-title h6 mb-0">Group Details</h5>
            </div>
            <div class="card-body p-4">
                <form method="POST" action="{{ route('admin.newsletter.groups.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" required placeholder="e.g. VIP Customers">
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" rows="3" placeholder="Explain who belongs to this list segment...">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3 form-check">
                        ...
                        <input type="checkbox" name="is_dynamic" value="1" id="is_dynamic" class="form-check-input @error('is_dynamic') is-invalid @enderror" {{ old('is_dynamic') ? 'checked' : '' }}>
                    ...
                    <div class="mb-4 form-check">
                        ...
                        <input type="checkbox" name="status" value="1" id="status" class="form-check-input @error('status') is-invalid @enderror" {{ old('status', 1) ? 'checked' : '' }}>
