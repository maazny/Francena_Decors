...
@section('title', 'Edit Testimonial Category')

@section('content')
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-md-8">
            <h2 class="mb-0">Edit Testimonial Category</h2>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.testimonial-categories.update', $testimonialCategory) }}" method="POST">
                @csrf
                @method('PUT')
