        ...
        <div class="tab-pane fade show active" id="general" role="tabpanel">
          <div class="row g-3">
            <div class="col-md-8">
              ...
              <input type="text" name="title" id="title-field" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" required>
              @error('title')
          ...
          <div class="row g-3">
            <div class="col-md-6">
              <div class="card p-3 border shadow-sm">
                ...
                <input type="hidden" name="featured_image_id" id="featured_image_id" value="{{ old('featured_image_id') }}">
                <div class="d-flex align-items-center gap-3">
                  ...
                  <img id="featured_image_id_preview" src="" class="img-thumbnail d-none" style="max-height: 80px; max-width: 120px; object-fit: cover;">
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="card p-3 border shadow-sm">
                ...
                <input type="hidden" name="banner_image_id" id="banner_image_id" value="{{ old('banner_image_id') }}">
                <div class="d-flex align-items-center gap-3">
                  ...
                  <img id="banner_image_id_preview" src="" class="img-thumbnail d-none" style="max-height: 80px; max-width: 120px; object-fit: cover;">
                </div>
              </div>
            </div>
        ...
        <div class="tab-pane fade" id="publish" role="tabpanel">
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <input type="number" name="reading_time" class="form-control @error('reading_time') is-invalid @enderror" placeholder="Estimated automatically if left empty" value="{{ old('reading_time') }}">
              @error('reading_time')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
