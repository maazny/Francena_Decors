      ...
      <div class="row g-4">
        ...
        <div class="col-md-6">
          ...
          <select name="featured_image_id" class="form-select @error('featured_image_id') is-invalid @enderror">
            ...
            @foreach($imageOptions as $image)
              <option value="{{ $image->id }}" {{ old('featured_image_id', $post->featured_image_id) == $image->id ? 'selected' : '' }}>{{ $image->title }}</option>
            @endforeach
          </select>
        ...
        <div class="col-md-6">
          ...
          <select name="banner_image_id" class="form-select @error('banner_image_id') is-invalid @enderror">
            <option value="">Select image</option>
            @foreach($imageOptions as $image)
              <option value="{{ $image->id }}" {{ old('banner_image_id', $post->banner_image_id) == $image->id ? 'selected' : '' }}>{{ $image->title }}</option>
            @endforeach
          </select>
        ...
        <div class="col-12">
          ...
          <textarea name="seo_description" class="form-control @error('seo_description') is-invalid @enderror" rows="2">{{ old('seo_description', $post->seo_description) }}</textarea>
