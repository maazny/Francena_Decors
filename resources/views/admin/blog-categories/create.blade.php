...
@section('page-description', 'Create a new category for your blog posts.')

@section('content')
<div class="card shadow-sm">
  <div class="card-body p-4">
    <form method="POST" action="{{ route('admin.blog-categories.store') }}" novalidate>
      @csrf
      <div class="row g-4">
        <div class="col-md-6">
        ...
        <div class="col-12">
          ...
          <textarea name="description" class="form-control rich-editor @error('description') is-invalid @enderror" rows="5">{{ old('description') }}</textarea>
          @error('description')
            <div class="invalid-feedback">{{ $message }}</div>
          @enderror
        </div>
