...
class ApplicationStatusUpdatedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable): MailMessage
    {
        ...
        $mail = (new MailMessage)
            ->subject("Update regarding your application at Francena Decors: {$jobTitle}")
            ->greeting("Dear {$this->application->full_name},");

        if ($status === 'interviewing') {
            $mail->line("We are pleased to invite you for an interview for the **{$jobTitle}** position at Francena Decors.")
            ...
            $mail->line("Thank you for your interest in the **{$jobTitle}** position at Francena Decors.")
        ...
        $mail->line("Thank you for your interest in Francena Decors.")
             ->line("Best regards,")
